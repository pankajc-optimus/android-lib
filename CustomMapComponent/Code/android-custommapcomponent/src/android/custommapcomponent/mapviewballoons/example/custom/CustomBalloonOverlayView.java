...
package android.custommapcomponent.mapviewballoons.example.custom;
...
import android.custommapcomponent.R;
import android.custommapcomponent.utilities.NewFormActivity;
...
public class CustomBalloonOverlayView<Item extends OverlayItem> extends
	...
	Button btnSwitchToAnotherActivity;
	...
	protected void setupView(final Context context, final ViewGroup parent) {
		...
		btnSwitchToAnotherActivity = (Button) v
				.findViewById(R.id.switchToOtherActivity);

		// set up the listener to switch from this activity to other on the click
		// of this button
		btnSwitchToAnotherActivity.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intentNewForm = new Intent(context,
						NewFormActivity.class);
				context.startActivity(intentNewForm);
